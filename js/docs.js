...
(function (root, factory) {
    ...
    var _ = function () {
        ...
        return {
            isMsie: function () {
            ...
            }, isArray: $.isArray, isFunction: $.isFunction, isObject: $.isPlainObject, isUndefined: function (obj) {
            ...
            }, bind: $.proxy, each: function (collection, cb) {
                $.each(collection, reverseArgs);

                function reverseArgs(index, value) {
                    return cb(value, index);
                }
            }, map: $.map, filter: $.grep, every: function (obj, test) {
                var result = true;
                if (!obj) {
                    return result;
                }
                ...
                return !!result;
            }, mixin: $.extend, identity: function (x) {
                return x;
            }, clone: function (obj) {
            ...
            function traverse(el, hightlightTextNode) {
                ...
                for (var i = 0; i < el.childNodes.length; i++) {
                    ...
                    if (childNode.nodeType === TEXT_NODE_TYPE) {
                        i += hightlightTextNode(childNode) ? 2 : 0;
                    } else {
    ...
    var Dataset = function () {
        ...
        keys = {dataset: "tt-selectable-dataset", val: "tt-selectable-display", obj: "tt-selectable-object"};
        ...
        _.mixin(Dataset.prototype, EventEmitter, {
            ...
            }, cancel: $.noop, clear: function clear() {
                this._empty();
                this.cancel();
    ...
    var Status = function () {
        ...
        function Status(options) {
            this.$el = $("<span></span>", {role: "status", "aria-live": "polite"}).css({
                position: "absolute",
                padding: "0",
                border: "0",
                height: "1px",
        ...
        _.mixin(Status.prototype, {
            update: function update(event, suggestions) {
                ...
                var words;
                if (length === 1) {
                    words = {result: "result", is: "is"};
                } else {
                    words = {result: "results", is: "are"};
                }
    ...
    (function () {
        ...
        methods = {
            initialize: function initialize(o, datasets) {
                ...
                function attach() {
                    ...
                    status = new Status({$input: $input, menu: menu});
        ...
        function prepInput($input, www) {
            ...
            $input.addClass(www.classes.input).attr({spellcheck: false});
            try {
...
!function () {
    (function ($) {
        var source = {
            limit: 10, source: function (query, sync, async) {
                query = query.toLowerCase();
                $.getJSON('https://zhoudl.jschrj.com/search.json', function (data, status) {
        ...
        $('[data-docs-search]').typeahead({highlight: false}, source).on('typeahead:select', function (e, sel) {
            window.location.href = "https://zhoudl.jschrj.com"+sel.link;
        });
...
/**
 * This module generates a table of contents from the <h4>s on a page.
 * 这个模块是遍历列表中的 docs-component h4 标签生成 on this page
 */
